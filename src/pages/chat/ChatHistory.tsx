...
export default function ChatHistory() {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      setLoading(true);
      try {
        const history = await chatHistoryService.getAll();
  ...
  const handleDeleteMessage = async (messageId: string) => {
    ...
    try {
      ...
      setQaHistory((prev) => prev.filter((m) => m.messageId !== messageId));
    } finally {
      setDeleting(null);
    }
  };
  ...
  const handleDeleteAll = async () => {
    ...
    setDeleting("all");
    try {
      await chatHistoryService.deleteAll();
      setQaHistory([]);
    } finally {
      setDeleting(null);
    }
                          ...
                          >
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <Button
                                ...
                                disabled={deleting === item.messageId}
                                title="Delete Q&A"
                                className="ml-1 mt-1"
                              >
